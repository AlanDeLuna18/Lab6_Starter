...
function initFormHandler() {
	...
	const form = document.querySelector("form"); //this part is wrong? 
	...
	form.addEventListener("submit", function(event) {
		...
		mainEl.append(newRecipe); //Possible scope issue here
		
		// B9. TODO - Get the recipes array from localStorage, add this new recipe to it, and
		//            then save the recipes array back to localStorage
		let recipes = JSON.parse(localStorage.getItem("recipes")) || [];
		recipes.push(recipeObject);
		saveRecipesToStorage(recipes); // Reuse your helper function
	}); 
	
	// B10. TODO - Get a reference to the "Clear Local Storage" 
